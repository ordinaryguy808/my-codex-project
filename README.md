...
It can list, create, and edit devices and review customer requests. The public
early-access request form is available at `http://localhost:4173/customize`.
...
Uploaded request artwork is stored outside the public asset list in
`data/uploads/`. Both the database and uploads are ignored by Git. Files can only
be downloaded through the request-specific admin download endpoint.
